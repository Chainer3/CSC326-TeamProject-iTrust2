...
public class APIOfficeVisitTest {
    ...
    public void testBuildOfficeVisitCPTCodes () {
        ...
        assertEquals( 1, (long) list2.get( 0 ).getVersion() );
        ...
        assertEquals( 1, (long) list2.get( 1 ).getVersion() );
        ...
        assertEquals( 1, (long) list2.get( 2 ).getVersion() );
